...
public class User {
    ...
    protected static String whitePlayer= Chessmate.chessGameInfo.whitePlayerField.getText();
    protected static String blackPlayer= Chessmate.chessGameInfo.blackPlayerField.getText();
    ...
    User(){
//        whitePlayer=Chessmate.ChessGUI.whitePlayer;
//        blackPlayer = Chessmate.ChessGUI.blackPlayer;
    }
...
//the user is allowed into their account
    ...
    public static boolean checkUsernameValidity(String username){
        ...
        try {
            File myObj = new File("resources/Game Data Files/UsersAccounts.txt");
            Scanner myReader = new Scanner(myObj);
            while (myReader.hasNextLine()) {
                String storedUser = myReader.nextLine();
                if (!storedUser.isEmpty()) {
